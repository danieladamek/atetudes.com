...
export default {
  ...
  present: {
    ...
    /* v0.6.0 (261009, night 47 — alternate tunings item 2): the string labels are the editor —
     * six steppers under the neck, ±6 semitones each, a crossing refused at the point of the
    ...
    /* v0.6.6 (261011, night 46 — CR-1 role A, §2.6's material clause ratified 261010): a chord-supplied
    ...
    /* v0.6.18 (261024, night 66): Presets becomes Settings — the card describes the étude from the one record the
     * practice log saves (hub/etude-record.mjs); the shut Motif rail keeps its word. */
    /* v0.6.17 (261023, night 65 — the motif is named): the neck's side rail is headed Motif (the span
     * Take/Movement → figure, approved by Daniel 261022), and the readout says the movement it omitted. */
    ...
    blurb: "one tool that holds many études · v0.6.18",
