...
@media (max-width:719px){
  ...
  mount(ctx) {
    ...
    surface = createNotepadSurface({
      adapter: {
        app: doorId, version: 2,   // v2 (night 59): the payload carries no `object`; v1 payloads are read, their object a label
        ...
        /* ONLY TONES IS STORED (night 59 — the Centricity re-cut): the object is the name the tones make
